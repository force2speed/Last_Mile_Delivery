...
import { Truck, User, Mail, Lock, Phone, ArrowRight, ShieldCheck, Globe, Clock } from "lucide-react";
      ...
      <div className="z-10 w-full max-w-md">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="mb-8">
          ...
          <p className="text-lg text-white/90 font-medium leading-relaxed drop-shadow-md">
            Register your company to immediately access enterprise-grade logistics orchestration and global shipping tools.
          </p>
        </motion.div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative">
        ...
        >
          ...
          <div className="space-y-2 mb-8">
            ...
            <p className="text-sm text-slate-500 font-medium">Create your corporate account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-[#0033a0] transition-colors" />
                <input
                  type="text" required autoFocus
                  className="w-full bg-slate-50 border border-slate-300 rounded-lg pl-11 pr-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#0033a0] focus:ring-2 focus:ring-[#0033a0]/20 transition-all shadow-sm"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                <Phone className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-[#0033a0] transition-colors" />
                <input
                  type="text" required
                  className="w-full bg-slate-50 border border-slate-300 rounded-lg pl-11 pr-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#0033a0] focus:ring-2 focus:ring-[#0033a0]/20 transition-all shadow-sm"
          ...
          <div className="text-center text-slate-500 text-sm mt-6 pt-4 border-t border-slate-100">
            Already registered?{" "}
            <Link href="/login" className="text-[#0033a0] hover:text-[#002277] font-bold transition-colors underline decoration-[#0033a0]/30 underline-offset-4">
              Sign In Instead
            </Link>
          </div>
        </motion.div>
